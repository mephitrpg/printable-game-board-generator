console.log('npx http-server --cors');
            ...
            */];
            ...
            const THEMES = {
                ...
                'Black': { light: '#ffffff', mid: '#b0b0b0', dark: '#000000' },
                'Red': { light: '#ffffff', mid: '#e58a8a', dark: '#aa0000' },
                'Gray': { light: '#ffffff', mid: '#d7d7d7', dark: '#acacac' },
                'Wikipedia': { light: '#ffce9e', mid: '#e8ab6f', dark: '#d18b47' },
                'LiChess.org': { light: '#f0d9b5', mid: '#d9b58a', dark: '#b58863' },
                'Chess.com': { light: '#ebecd0', mid: '#aebd91', dark: '#739552' },
                'HexChess.com': { light: '#a5c8df', mid: '#80b1d0', dark: '#4180a9' }
